    ...
    <View className="flex-1 bg-[#F9FAFB]">
      ...
      >
        ...
        <Text className="mt-1 text-sm text-slate-500">
          Manage your company relationships and projects.
        </Text>
        ...
        <Text className="mb-3 mt-2 text-lg font-bold text-slate-800">
          Client Directory
        </Text>
        <View className="gap-3">
          {clients.map(([name, project, status, color]) => (
            <View
              key={name}
              className="flex-row items-center rounded-3xl border border-slate-100 bg-white p-4 shadow-sm"
            >
