...
export default function AdminDashboard() {
  ...
  return <View className="flex-1 bg-white"><TopHeader /><ScrollView className="flex-1" contentContainerStyle={{ paddingHorizontal: 20, paddingTop: 12, paddingBottom: 120 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => fetchDashboard(true)} tintColor="#f97316" />}>
    ...
    <View className="mb-5 overflow-hidden rounded-[28px] bg-black p-5 shadow-lg shadow-black/20"><View className="flex-row items-start justify-between"><View className="flex-1 pr-4"><Text className="text-xs font-bold uppercase tracking-[2px] text-orange-500">Financial Overview</Text><Text className="mt-2 text-2xl font-black text-white">Revenue Insights</Text><Text className="mt-1 text-sm text-gray-400">Live income and payroll snapshot.</Text></View><Ionicons name="trending-up" size={28} color="#f97316" /></View><View className="mt-5 flex-row gap-3"><View className="flex-1 rounded-2xl bg-white/10 p-3"><Text className="text-[10px] font-bold uppercase text-gray-400">Income</Text><Text className="mt-1 text-xl font-black text-white">{money(income)}</Text></View><View className="flex-1 rounded-2xl bg-white/10 p-3"><Text className="text-[10px] font-bold uppercase text-gray-400">Payroll</Text><Text className="mt-1 text-xl font-black text-white">{money(dashboard?.monthlyPayroll)}</Text></View></View><View className="mt-4"><View className="mb-1 flex-row justify-between"><Text className="text-[10px] font-bold text-gray-400">Monthly target: Rs 5.0L</Text><Text className="text-[10px] font-black text-orange-500">{targetPercentage}%</Text></View><View className="h-2 overflow-hidden rounded-full bg-white/10"><View className="h-full rounded-full bg-orange-500" style={{ width: `${targetPercentage}%` }} /></View></View></View>
