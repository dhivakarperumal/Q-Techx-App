...
export default function EmployeeProjectDetailsScreen() {
  ...
  const fetchDetails = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      setEmployees(assignmentsResponse.data?.assignedEmployees || assignmentsResponse.data?.employees || []);
