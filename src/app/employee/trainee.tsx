...
export default function TraineeScreen() {
  return (
    <View style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      <TopHeader title="Trainee & Internship" subtitle="Your learning journey" />
      <ScrollView
        style={{ flex: 1 }}
      ...
      >
        ...
        <Text style={{ marginTop: 6, fontSize: 15, color: "#64748b" }}>
          Track your training programs and internship experience.
        </Text>
                ...
                >
                  <View
                    style={{
                      height: 7,
                      borderRadius: 10,
                      backgroundColor: prog.progressColor,
                      width: `${prog.progress}%`,
                    }}
                  />
                </View>
